...
const GFClassroom3 = () => {
  return (
    ...
    {/* Back Button */}
    <div className="absolute bottom-18 left-6  flex flex-col items-center text-black group">
      ...
      <span className="text-sm font-semibold mt-1">Back</span>
    </div>
