    ...
    <div className="min-h-screen bg-white px-4 pt-6 pb-12 flex flex-col items-center relative">
      ...
      {/* Description */}
        <p className="text-center text-gray-700 max-w-2xl leading-relaxed">
         The teacher room at JTLC is a dedicated space for educators to prepare lessons, collaborate with colleagues, and take breaks between classes. 
         It fosters a professional and supportive environment to enhance teaching quality and staff well-being.
        </p>
    </div>
  );
};
